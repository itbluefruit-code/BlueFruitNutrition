...
const customersSchema = new Schema({
  ...
  email: { type: String, required: true, unique: true, match: /^[a-zA-Z0-9._-]+@[a-zA-Z0-9._-]+\.[a-zA-Z]{2,6}$/ },
  ...
  expireAt: { type: Date, default: () => new Date(Date.now() + 2*60*60*1000), index: { expires: 0 } }
}, { timestamps: true });
